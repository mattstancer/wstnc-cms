        ...
        <div class="workstation">
            ...
            <div style="width:600px; margin-top:10px; float:left; border-right:solid 1px black; margin-bottom:10px;">
                <div style="margin-left:auto; margin-right:auto; width:560px;">
                    <form name="formularz" method="post" action="sited.php">
                        <div class="tytul">
                            <input type="text" style="width:280px;" name="tytul"/>
                            <div id="author" class="righter" name="author">
                            <?php
                        ...
                        <div class="main">
                            ...
                            <textarea style="width:100%; height:200px;" name="tresc"></textarea>
                        </div>
                        <div class="photo1"><input type="file" name="file1" id="file"></div>
                        <div class="photo2"><input type="file" name="file2" id="file"></div>
                        <div class="photo3"><input type="file" name="file3" id="file"></div>
                        <div class="photo4"><input type="file" name="file4" id="file"></div>
                        <div class="photo5"><input type="file" name="file5" id="file"></div>
                        <div class="photo6"><input type="file" name="file6" id="file"></div>
                        <div class="photo7"><input type="file" name="file7" id="file"></div>
                        <div class="photo8"><input type="file" name="file8" id="file"></div>
                        <div class="photo9"><input type="file" name="file9" id="file"></div>
